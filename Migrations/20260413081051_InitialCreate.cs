        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Difficulty = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ColorGradient = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Emoji = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CalorieMin = table.Column<int>(type: "int", nullable: false),
                    CalorieMax = table.Column<int>(type: "int", nullable: false),
                    ...
                    SampleMealsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TipsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuddyRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuddyRequests_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BuddyRequests_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityRecipes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommunityRecipes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adherent = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DayLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CookingStyle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Budget = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DietSlug = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditHistoryJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeLikes_CommunityRecipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "CommunityRecipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeSaves", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeSaves_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeSaves_CommunityRecipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "CommunityRecipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuddyRequests_ReceiverId",
                table: "BuddyRequests",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_BuddyRequests_SenderId",
                table: "BuddyRequests",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityRecipes_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeSaves_RecipeId",
                table: "RecipeSaves",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeSaves_UserId",
                table: "RecipeSaves",
                column: "UserId");
