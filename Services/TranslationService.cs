...
namespace MoodBite.Services
{
    public class TranslationService
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ...
            ["clinic.patients.detailsSubtitle"] = new() { ["ar"] = "صفحة مؤقتة لتأكيد ربط المريض وحالة الموافقة.", ["en"] = "A placeholder page for confirming patient link and consent status." },
