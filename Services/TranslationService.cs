...
namespace MoodBite.Services
{
    public class TranslationService
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ...
            ["clinic.shellReadyBody"] = new() { ["ar"] = "هذه المرحلة تضيف الهيكل والتنقل فقط. إدارة المرضى والمواعيد والملاحظات ستأتي في مراحل لاحقة.", ["en"] = "This phase adds the structure and navigation only. Patient, appointment, and notes workflows come later." },
