...
namespace MoodBite.Services
{
    public class TranslationService
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ...
            ["clinic.shellReadyBody"] = new() { ["ar"] = "ابدأ من قائمة المرضى لإضافة مرضى العيادة أو دعوتهم، بينما ستأتي المواعيد والملاحظات في مراحل لاحقة.", ["en"] = "Start from the patient roster to add or invite clinic patients. Appointment and notes workflows come later." },
