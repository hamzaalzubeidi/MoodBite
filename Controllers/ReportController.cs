...
namespace MoodBite.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        public ReportController(ApplicationDbContext db, UserManager<ApplicationUser> userManager, ReportService reportService)
        {
            _db = db;
        ...
        public async Task<IActionResult> ExportPdf()
        {
            ...
            var html = GenerateReportHtml(user!, report);
            var bytes = Encoding.UTF8.GetBytes(html);
            return File(bytes, "text/html", $"moodbite-report-{DateTime.Today:yyyy-MM-dd}.html");
        }

        private static string GenerateReportHtml(ApplicationUser user, ReportData report)
        {
            ...
            return string.Concat(
                ...
                $"<tr><td>الحالة المزاجية الأكثر</td><td>{report.TopMood}</td></tr>",
